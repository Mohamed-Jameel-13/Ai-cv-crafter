...
var ContentEditable = import_react.default.memo(import_react.default.forwardRef(function ContentEditable2(_a, ref) {
  ...
  var elRef = import_react.default.useRef();
...
function Dropdown(_a) {
  ...
  return import_react.default.createElement(
    "select",
    __assign({}, inputProps, { value: selected, className: "rsw-dd" }),
...
function Separator() {
  ...
  return import_react.default.createElement("div", { className: "rsw-separator" });
}
function Toolbar(props) {
  return import_react.default.createElement("div", __assign({}, props, { className: "rsw-toolbar" }));
}
