const EducationalPreview = ({ resumeInfo }) => {
  ...
  return (
    <div className="mt-0">
      <h2 className="text-center font-bold text-sm mb-0.5">
        Education
      </h2>
      <hr className="border-[1px] my-0.5" style={{borderColor: resumeInfo?.themeColor || "rgb(107 114 128)"}} />
        ...
        <div key={index} className="mb-1">
          <div className="flex justify-between items-center">
            ...
            <span className="text-xs">
              {[educationItem?.city, educationItem?.state].filter(Boolean).join(', ')}
            </span>
          </div>
